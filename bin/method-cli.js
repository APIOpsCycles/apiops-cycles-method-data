...
function printUsage() {
  console.log(`Usage:
  node ./bin/method-cli.js start [--cycle <cycle-id>] [--locale <locale>] [--default-locale <locale>] [--json] [--list] [--answers <yes,no,...>] [--next-action <resources|canvases|exit>]
  node ./bin/method-cli.js resources --station <station-id> [--cycle <cycle-id>] [--locale <locale>] [--style <style>] [--json] [--list] [--step-actions <details,next,...>]
  node ./bin/method-cli.js generate-canvases [--station <station-id> | --stations <ids> | --preset new-api] [--cycle <cycle-id>] [--locale <locale>] [--style <style>] [--output <dir>] [--force] [--json]

Examples:
  node ./bin/method-cli.js start --locale en
  node ./bin/method-cli.js start --cycle api-productization-cycle --locale en
  node ./bin/method-cli.js start --default-locale en
  node ./bin/method-cli.js start --locale en --answers yes,no,yes --next-action resources
  node ./bin/method-cli.js resources --station api-product-strategy --cycle api-productization-cycle --locale en
  node ./bin/method-cli.js generate-canvases --preset new-api --cycle api-productization-cycle --style REST --output ./specs/canvases
`);
}
